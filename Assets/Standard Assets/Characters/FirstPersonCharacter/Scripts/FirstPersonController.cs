...
// Removed one field and assigned default values to uninitialized fields in order to remove Warnings
...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [Header("Wwise Events")]
        public AK.Wwise.Event footstepsEvent = default;
        public AK.Wwise.Event jumpEvent = default;
        public AK.Wwise.Event landEvent = default;
        
        private Camera m_Camera = default;
        private bool m_Jump = default;
        // private float m_YRotation = default; // Currently unused; commented out.
        private Vector2 m_Input = default;
        private Vector3 m_MoveDir = Vector3.zero;
        private CharacterController m_CharacterController = default;
        private CollisionFlags m_CollisionFlags = default;
        private bool m_PreviouslyGrounded = default;
        private Vector3 m_OriginalCameraPosition = default;
        private float m_StepCycle = default;
        private float m_NextStep = default;
        private bool m_Jumping = default;
